...
const search =  `herbarium AND unit_code:"NMNHBOTANY" online_media_type:"Images"`;
...
function addObject(objectData) {  
  ...
  if (objectData.content.indexedStructured) {
    taxonomyData.scientificName = objectData.content.indexedStructured.scientific_name[0] || "NA";
    taxonomyData.taxClass = objectData.content.indexedStructured.tax_class[0] || "NA";
    taxonomyData.taxFamily = objectData.content.indexedStructured.tax_family[0] || "NA";
    taxonomyData.taxKingdom = objectData.content.indexedStructured.tax_kingdom[0] || "NA";
    taxonomyData.taxOrder = objectData.content.indexedStructured.tax_order[0] || "NA";
  }
  ...
  myBotStudies.push({
    id: objectData.id,
    title: objectData.title || "NA",
    img: image_url,
    scientificName: taxonomyData.scientificName,
    taxClass: taxonomyData.taxClass,
    taxFamily: taxonomyData.taxFamily,
    taxKingdom: taxonomyData.taxKingdom,
    taxOrder: taxonomyData.taxOrder,
  });
}
